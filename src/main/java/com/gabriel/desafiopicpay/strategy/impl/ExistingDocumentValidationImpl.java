...
@Slf4j
@Component
public class ExistingDocumentValidationImpl implements NewUserValidationStrategy {
    ...
    private boolean existsDocument(UserRequest userRequest) {
        return userRepository.existsByDocument(userRequest.document());
    }
